...
c     FILENAME: PUU_VERT.F
c     Released: 07:08:2007 (J.R.)
 
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c   This file contains pseudoscalar-up q-up q vertex formfactors      c
c                                                                     c
...
c     Down squark-chargino-chargino in loop
      ...
      do l=1,2
        do m=1,2
          a1 = ci*(v_ccp(m,l,k) - dconjg(v_ccp(l,m,k)))
          b1 = v_ccp(m,l,k) + dconjg(v_ccp(l,m,k))
          do n=1,6
            ...
            do kk=1,2
              form(kk) = form(kk) + e/8/sq2/st*tmp(kk)
            end do
          end do
        end do
      end do
...
c     Chargino-down squark-down squark in loop
      ...
      do l=1,6
        do m=1,6
          ...
          do n=1,2
            ...
            b3 = ci*(vr_udc(i,m,n) - vl_udc(i,m,n))
            ...
            do kk=1,2
              form(kk) = form(kk)  - ci*cv/4*tmp(kk)
            end do
          end do
        end do
      end do
      ...
      subroutine puu_vert0_3(i,j,k,form)
c     Up squark-neutralino-neutralino in loop
      implicit double precision (a-h,o-z)
      double complex tmp(2),form(2),a1,a2,a3,b1,b2,b3
      double complex v_nnp,vl_uun,vr_uun
      ...
      do l=1,4
        do m=1,4
          a1 = - ci*(v_nnp(l,m,k) + dconjg(v_nnp(m,l,k)))
          b1 = - v_nnp(l,m,k) + dconjg(v_nnp(m,l,k))
          do n=1,6
...
c     Neutralino-up squark- up squark in loop
      ...
      do l=1,6
        do m=1,6
          ...
          do n=1,4
            ...
            a2 = dconjg(vr_uun(j,l,n) + vl_uun(j,l,n))
      ...
      subroutine puu_vert0_5(i,j,k,form)
c     Gluino-up squark- up squark in loop
      implicit double precision (a-h,o-z)
      double complex tmp(2),form(2),a2,a3,b2,b3
      double complex v_uup
      ...
      do l=1,6
        do m=1,6
          ...
          do n=1,2
            form(n) = form(n) - ci*8*pi*al/3.d0*v_uup(l,m,k)*tmp(n)
          end do
        end do
      end do
      return
      ...
      subroutine puu_svert0(i,j,k,form)
c     Full bare Puu formfactors at vanishing external momenta
      implicit double precision (a-h,o-z)
      ...
      call puu_vert0_1(i,j,k,form)
      call puu_vert0_2(i,j,k,form)
      call puu_vert0_3(i,j,k,form)
      call puu_vert0_4(i,j,k,form)
      call puu_vert0_5(i,j,k,form)
c     No charged Higgs here at present
c      call puu_vert0_6(i,j,k,form)
c      call puu_vert0_7(i,j,k,form)
      do l=1,2
...
c      subroutine puu_ren0(i,j,k,form)
c     Full renormalized Puu formfactors
